                ...
                <div className="flex justify-center items-center flex-col  h-screen">
                         <div className="container">
                            <div className="valentines ">
                                ...
                                <div className="card customFont" style={{ fontSize: '14px' }} data-content={`Lets go to ${data.location} at ${data.time} ❤️`}><div className="card customFont" style={{ fontSize: '14px' }} data-content={`Lets go to ${data.location} at ${data.time} ❤️`}>
                                        <div className="text">
